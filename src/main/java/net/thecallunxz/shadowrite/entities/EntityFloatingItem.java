...
public class EntityFloatingItem extends EntityItem
{
    ...
    private static final DataParameter<ItemStack> ITEM = EntityDataManager.<ItemStack>createKey(EntityFloatingItem.class, DataSerializers.ITEM_STACK);
    ...
    {
        for (EntityFloatingItem entityitem : this.world.getEntitiesWithinAABB(EntityFloatingItem.class, this.getEntityBoundingBox().grow(0.5D, 0.0D, 0.5D)))
        {
     ...
     */
    private boolean combineItems(EntityFloatingItem other)
    {
        return false;
    }
    ...
    {
        fixer.registerWalker(FixTypes.ENTITY, new ItemStackData(EntityFloatingItem.class, new String[] {"Item"}));
    }
    ...
    public Entity changeDimension(int dimensionIn, net.minecraftforge.common.util.ITeleporter teleporter)
    {
        ...
        if (!this.world.isRemote && entity instanceof EntityFloatingItem)
        {
            ((EntityFloatingItem)entity).searchForOtherItemsNearby();
        }
