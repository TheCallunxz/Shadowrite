...
public class RenderFloatingItem extends Render<EntityFloatingItem>
{
    ...
    private int transformModelCount(EntityFloatingItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
    ...
    public static class Factory implements IRenderFactory<EntityFloatingItem> {
		public Render<? super EntityFloatingItem> createRenderFor(RenderManager manager) {
			return new RenderFloatingItem(manager, Minecraft.getMinecraft().getRenderItem());
		}
	}
}